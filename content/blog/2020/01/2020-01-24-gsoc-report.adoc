...
Google Summer of Code never is a summer internship program, but actually it is a year-round effort for the organization and some community members.
...
We are happy to announce that five projects were successfully completed: 
...
We would like to start this report by thanking all participants, students, mentors, subject matter experts and community members who support the project and the students.
...
and we sent link:TODO[Marky Jackson] and link:TODO[Oleg Nenashev] as representatives there.

You can find a travel report from Marky link:TODO[here].
Apart from discussing projects and sharing chocolate, we also presented Jenkins there and hosted the unconference session about bots.

TODO: Photo of all mentors
...
This year we four students traveled to the DevOps World | Jenkins World conferences in link:https://www.cloudbees.com/devops-world/san-francisco[San-Francisco] and link:https://www.cloudbees.com/devops-world/lisbon[Lisbon].
...
You can find a travel report from Natasha link:TODO[here],
more travel reports are coming soon.

TODO: Add several photos
