...
We would like to thank all our students, their mentors and to all other contributors who proposed project ideas, participated in student selection, in community bonding and in further reviews.
...
We also capture in that document contact information such as github and gitter handles, and a preliminary list of potential mentors for the project.
...
Gitter threads was added recently (Nov 2019) but does not work well yet on Android and iOS.
...
This year, five projects were successfully completed. We find this to be normal an in line with what we hear from other participating organizations.

Taking the time early to update our GSoC pages saved us a lot of time later on because we did not have to repeat all the information every time someone contacted us.
